...
const Techstack = () => {
  return (
    <div className="bg-[#141313] absolute top-[100px] left-[809px] h-80 w-44 rounded-[20px] ">
      <div className="flex flex-col justify-start items-center">
        <div className="text-white flex justify-center items-center py-6">
          <h1 className="font-bold text-xl px-2">Techstack</h1>
        ...
        <div className="flex flex-col justify-center items-start">
          <div className="flex items-center pt-5">
            ...
            <h1 className="text-white font-semibold text-sm px-2">HTML</h1>
          </div>
          <div className="flex items-center pt-5">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <h1 className="text-white font-semibold text-sm px-2">CSS</h1>
          </div>
          <div className="flex items-center pt-5">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <h1 className="text-white font-semibold text-sm px-2">
              JavaScript
            </h1>
          </div>
          <div className="flex items-center pt-5">
            ...
            <h1 className="text-white font-semibold text-sm px-2">Solidity</h1>
          </div>
